...
$select_enquiry = "SELECT * FROM `$table_name` where status = 'Active' AND leave_status = 'Accepted' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql = $dbconn->prepare($select_enquiry);
$sql->execute();
                ...
                <div class="card-header border-0">
                    <nav style="font-size:20px;">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active btn btn-lg  text-primary" href="#" aria-selected="false">Accepted</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display: flex; justify-content: center; align-items: baseline; gap: 7px;">
                                                <!-- <a href="index.php?module=Module&view=Accept&id=<?php echo $field1; ?>" data-toggle="tooltip" title="Accept"><i class="material-icons" style="font-size:18px; color:green; margin-left: 2px;">check_circle</i></a>
