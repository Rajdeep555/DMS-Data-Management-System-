...
$select_enquiry = "SELECT * FROM `$table_name` where status = 'Active' AND leave_status = 'Pending' order by id desc";
...
$select_enquiry = "SELECT * FROM `$table_name` where status = 'Active' AND leave_status = 'Pending' order by id desc LIMIT $offset, $no_of_records_per_page";
$sql = $dbconn->prepare($select_enquiry);
$sql->execute();
                ...
                <div class="card-header border-0" style="padding: 30px 30px 0px 30px;">
                    <nav style="font-size:20px;">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active btn btn-lg  text-primary" href="#" aria-selected="true">Pending</a>
                            <a class="nav-item nav-link  btn btn-lg" href="index.php?module=Leave-Request&view=Accepted" aria-selected="false">Accepted</a>
                            <a class="nav-item nav-link  btn btn-lg" href="index.php?module=Leave-Request&view=Rejected" aria-selected="false">Rejected</a>
                        </div>
                    </nav>
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody id="employeeTable">
                                        ...
                                        <td>
                                            ...
                                            <div style="display: flex; justify-content: center; align-items: baseline; gap: 7px;">
                                                ...
                                                <a href="#" onclick="rejectLeave(<?php echo $field1; ?>, this)" data-toggle="tooltip" title="Reject">
                                                    <i class="material-icons" style="font-size:18px; color:orange; margin-left: 2px;">cancel</i>
                                                </a>
                                                <a href="index.php?module=Leave-Request&view=Delete&id=<?php echo $field1; ?>" target="_self" onclick="return confirm('Are you sure you want to Remove?');">
                                                    <i class="material-icons" style="font-size:18px; color:red; margin-left: 2px;">delete</i>
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
                            ...
                            <?php
                                ...
                                // Display empty message when no data is found
                                echo '<tr><td colspan="7" style="text-align: center; color: red;">No leave requests available</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
