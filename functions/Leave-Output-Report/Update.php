...
$module_application  = $rows1->module_application;
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    ...
                                    <input class="form-control" name="id" type="hidden" value="<?php echo $id; ?>" required>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                                <input class="form-control" name="field1" type="text" value="<?php echo $module_name; ?>" required>
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-select" name="field2" aria-label="Default select example">
                                                    <option  selected value="<?php echo $a_id; ?>"><?php echo $application_name; ?></option>
                                                    <?php
                                                    ...
                                                    $application_n = $rows11->application_name;
                                                    
                                                    ?>
                                                    <option value="<?php echo $application_id; ?>"><?php echo $application_n; ?></option>
                                                    <?php
                                                    }
                                                    }
                                                    ?>
