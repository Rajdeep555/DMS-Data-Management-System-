...
$month_year = $salary_details['month_year'] ?? '0';

// Format month_year to "M-YYYY"
if ($month_year !== '0') {
    // Split the month_year into month and year
    list($month, $year) = explode('-', $month_year);
    // Create a DateTime object using the correct format
    $dateTime = DateTime::createFromFormat('!m-Y', $month . '-' . $year);
    $month_year = $dateTime ? $dateTime->format('M-Y') : '0';
}
...
<body>
    ...
    <div class="container mb-5">
        ...
        <table class="details">
            ...
            <tr>
                <td class="fw-bold f-12" style="background-color:rgba(171, 193, 25, 0.81);">Number of Absent Days : &nbsp; &nbsp;
                    <span class="fw-bold">
                        <?php echo isset($salary_details['absent_days']) ? $salary_details['absent_days'] : '0'; ?>
                    </span>
                </td>
        ...
        <table class="salary-table">
            ...
            <tr>
                ...
                <td>(A)</td>
                <td class="fw-bold" style="background-color: rgba(171, 193, 25, 0.81);" id="gross_salary">
    ...
    <script>
        ...
        function calculateSalaryComponents(grossSalary) {
            ...
            const absentDaysText = document.querySelector('td[style*="background-color:rgba(171, 193, 25, 0.81)"] span').textContent.trim();
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (grossSalaryElement) {
                const grossSalary = parseFloat(grossSalaryElement.textContent.replace(/,/g, '')) || 0;
