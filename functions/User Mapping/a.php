                ...
                <div class="card-header border-0">
                    <nav style="font-size:20px;">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link  btn btn-lg" href="index.php?module=User Mapping&view=Create" aria-selected="true">Create User Mapping</a>
                        </div>
                    </nav>
                </div>
                                ...
                                <div class="col-md-6  pd-2">
                                    <div class="card border">
                                        <div class="card-header">
                                            <h6 class="text-center"><?php echo $group ?></h6>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <div class="row m-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" name="field1" aria-label="Default select example" required="required">
                                                            ...
                                                            <?php
                                                            $select_bookings = "SELECT * FROM `users` where user_role='$group' and status = 'Active'";
 ...
 <?php
                        ...
                        ?>
                                <div class="col-md-6  pd-2">
                                    <div class="card border">
                                        <div class="card-header">
                                            <h6 class="text-center"><?php echo $subgroup ?></h6>
                                        </div>
                                        <div class="card-body">
 <form id="formID" method="POST" action="">
