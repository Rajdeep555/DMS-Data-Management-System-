...
$select_enquiry11 = "SELECT * FROM `user_mapping` where status = 'Active' and user_map_parent='$parent_id'";
...
$select_enquiry12 = "SELECT * FROM users where id='$parent_id' and status = 'Active'";
...
<div class="container-fluid">
                ...
                <div class="card-header border-0">
                    <nav style="font-size:20px;">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <a class="nav-item nav-link active btn btn-lg text-primary" href="#" aria-selected="true"><i class="material-icons" style="font-size:14px;">edit</i>Edit</a>
                                                ...
                                                <div class="row m-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" name="field1" aria-label="Default select example" required="required">
                                                            ...
                                                            <option  value="<?php echo $rows12->id; ?>"  selected><?php echo $rows12->user_fname; ?> <?php echo $rows12->user_mname; ?> <?php echo $rows12->user_lname; ?>  ( <?php echo $rows12->user_role; ?> )</option>
                                                        ...
                                                        <select class="form-select" name="field2[]" multiple aria-label="Default select example" required="required">
                                                            ...
                                                            if($sql11){
                                                                foreach ($wlvd11 as $rows11){
                                                                    ...
                                                                    $select_enquiry211 = "SELECT * FROM users where id='$user_map_child' and status = 'Active'";
                                                                    $sql211 = $dbconn->prepare($select_enquiry211);
                                                                    $sql211->execute();
                                                                    $wlvd211 = $sql211->fetchAll(PDO::FETCH_OBJ);
                                                                    foreach ($wlvd211 as $rows211);
                                                            ?>
                                                            <option value="<?php echo $rows211->id; ?>" selected><?php echo $rows211->user_fname; ?> <?php echo $rows211->user_mname; ?> <?php echo $rows211->user_lname; ?>  ( <?php echo $rows211->user_role; ?> )</option>
                                                            <?php
                                                                }
                                                            }else{
                                                           ?>
                                                           <option value="" selected disabled>Select child</option>
                                                            ...
                                                            $select_enquiry212 = "SELECT * FROM users where user_role='$subgroup' and id!='$user_map' and status = 'Active'";
                                                            $sql212 = $dbconn->prepare($select_enquiry212);
                                                            $sql212->execute();
                                                            $wlvd212 = $sql212->fetchAll(PDO::FETCH_OBJ);
                                                            foreach ($wlvd212 as $rows212);
                                                            ...
                                                            ?>
                                                             ...
                                                             <option value="<?php echo $rows212->user_id; ?>"><?php echo $rows212->user_fname; ?> <?php echo $rows212->user_mname; ?> <?php echo $rows212->user_lname; ?>  ( <?php echo $rows212->user_role; ?> )</option>
                                                            <?php
                                                                }
                                                            }
                                                            }
 ...
 <form id="formID" method="POST" action="">
                                                ...
                                                <div class="row m-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" name="field1" aria-label="Default select example" required="required">
                                                             <option  selected><?php echo $rows12->user_fname; ?> <?php echo $rows12->user_mname; ?> <?php echo $rows12->user_lname; ?></option>
                                                            <!--<option selected disabled>Select Parent</option>-->
                                                            <?php
                                                            // $select_bookings = "SELECT * FROM `users` where user_role='$g' and status = 'Active'";
                                                            // $sql11 = $dbconn->prepare($select_bookings);
                                                            // $sql11->execute();
                                                            // $wlvd11 = $sql11->fetchAll(PDO::FETCH_OBJ);
                                                            // if ($sql11->rowCount() > 0) {
                                                            ...
                                                            ?>
                                                                    <!--<option value="<?php echo $user_id; ?>"><?php echo $user_fname; ?> <?php echo $user_map_parent; ?> <?php echo $user_lname; ?></option>-->
                                                            <?php
                                                            //     }
                                                            // }
                                                            ?>
                                                        ...
                                                        <select class="form-select" name="field2[]" multiple aria-label="Default select example" required="required" >
                                                            ...
                                                            if($sql11){
                                                                foreach ($wlvd11 as $rows11){
                                                                    ...
                                                                    foreach ($wlvd211 as $rows211);
                                                                ?>
                                                                <option value="" selected><?php echo $rows211->user_fname; ?> <?php echo $rows211->user_mname; ?> <?php echo $rows211->user_lname; ?>  ( <?php echo $rows211->user_role; ?> )</option>
                                                                <?php
                                                                }
                                                           ?>
                                                            <?php
