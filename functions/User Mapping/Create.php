                                                ...
                                                <div class="row m-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" name="field1" aria-label="Default select example" required="required">
                                                            ...
                                                            // $select_bookings = "SELECT * FROM `users` where user_role='$g' and id!='$user_map_parent' and status = 'Active'";
                                                              $select_bookings = "SELECT * FROM `users` where user_role='$g' and id NOT IN (SELECT user_map_parent FROM `user_mapping` where status = 'Active') and status = 'Active'";
                                                           ...
                                                           ?>
                                                            ...
                                                            // $select_bookings = "SELECT * FROM `users` where user_role='$g' and status = 'Active'";
                                                             $select_bookings = "SELECT * FROM `users` where user_role='$g' and status = 'Active' and id NOT IN (SELECT user_map_parent FROM `user_mapping` where status = 'Active')";
                                                            $sql11 = $dbconn->prepare($select_bookings);
                                                            $sql11->execute();
                                                            $wlvd11 = $sql11->fetchAll(PDO::FETCH_OBJ);
                                                            if ($sql11->rowCount() > 0) {
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-select" name="field1" aria-label="Default select example" required="required">
                                                            ...
                                                            if($sql11){
                                                                ...
                                                                $select_bookings = "SELECT * FROM `users` where user_role='$g' and status = 'Active' and id NOT IN ($ar_parent)";
                                                            $sql11 = $dbconn->prepare($select_bookings);
                                                            $sql11->execute();
                                                            $wlvd11 = $sql11->fetchAll(PDO::FETCH_OBJ);
                                                            if ($sql11->rowCount() > 0) {
                                                            ...
                                                            ?>
                                                                    <option value="<?php echo $user_id; ?>"><?php echo $user_fname; ?> <?php echo $user_map_parent; ?> <?php echo $user_lname; ?>  ( <?php echo $rows11->user_role; ?> )</option>
                                                            <?php
                                                                }
                                                                }
                                                            }
