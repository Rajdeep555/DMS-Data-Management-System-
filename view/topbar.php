...
$select_bookings = "SELECT * FROM `users` where status = 'Active' and `id`='$user_id'";
...
<div class="page-header">
    <div class="header-wrapper row m-0" height="20px">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.php?module=Dashboard"><img class="img-fluid" src="assets/images/logo/logo.png" alt=""></a></div>
        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div class="notification-slider">
                <div class="d-flex h-100">
                    ...
                    <h6 class="mb-0 f-w-400"><span class="font-primary"><a href="https://indiawebdesigns.in/"><b>MONSUT CHEM INDUSTRIES PVT LTD. </b></a></span><span class="f-light"></span></h6>
                ...
                <li class="profile-nav onhover-dropdown pe-0 py-0">
                    <div class="media profile-media">
                        ...
                        <div class="media-body"><span>
                                <h6><b><?php echo $rows->user_fname; ?> <?php echo $rows->user_lname; ?></b></h6>
                            </span>
                            <p class="mb-0 font-roboto"><?php echo $rows->user_role; ?> <i class="middle fa fa-angle-down"></i></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="index.php?module=Profile&view=List"><i data-feather="user"></i><span>Account </span></a></li>
                        <!--<li><a href="#"><i data-feather="mail"></i><span>Inbox</span></a></li>-->
                        <!--<li><a href="#"><i data-feather="file-text"></i><span>Taskboard</span></a></li>-->
                        <!--<li><a href="#"><i data-feather="settings"></i><span>Settings</span></a></li>-->
                        <li><a href="authentication.php?module=Logout"><i data-feather="log-in"> </i><span>Log out</span></a></li>
                    </ul>
                </li>
            </ul>
        </div>
